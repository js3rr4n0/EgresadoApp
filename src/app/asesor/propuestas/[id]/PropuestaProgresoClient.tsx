    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-border shadow-sm p-2 flex flex-wrap gap-2">
        ...
        >
          ...
          Documentación Final (4 Docs)
          <span className="text-[10px] bg-blue-100 text-blue-900 border border-blue-300 px-2 py-0.5 rounded font-extrabold uppercase">
            Dictámenes
          </span>
        </button>
      </div>
      ...
      {/* ============================================================= */}
      {/* PESTAÑA 4: DOCUMENTACIÓN FINAL (4 DOCUMENTOS OBLIGATORIOS / DICTÁMENES) */}
      {/* ============================================================= */}
      {activeTab === "documentos" && (
        <div className="pt-2 space-y-6">
          <div className="bg-gradient-to-r from-slate-900 via-slate-850 to-slate-900 text-white p-6 rounded-2xl shadow-md space-y-2 border border-slate-700">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-blue-500/20 text-blue-300 rounded-xl text-2xl border border-blue-500/30 shrink-0">
                📂
              </div>
              <div>
                <h3 className="font-extrabold text-base text-white">
                  Documentación Final y Dictámenes (4 Documentos Oficiales)
                </h3>
                <p className="text-xs text-slate-300 leading-relaxed mt-0.5">
                  Suba o administre los 4 documentos oficiales requeridos (Propuesta Aceptada/Modificada, Plan de Trabajo Firmado, Dictamen del Plan de Trabajo y Dictamen de la Propuesta). Los archivos subidos por usted estarán <strong>sincronizados en tiempo real en la base de datos con la vista del Coordinador de Facultad</strong>.
                </p>
              </div>
            </div>
          </div>
