    ...
    <div className="bg-white min-h-screen text-black">
      <div className="mx-auto bg-white p-8 print:p-0" style={{ maxWidth: '800px' }}>
        ...
        <div className="mb-8 flex justify-end print:hidden">
          <button onClick={() => window.print()} className="bg-brand-red text-white px-6 py-2 rounded-lg font-bold shadow-md flex items-center gap-2 hover:bg-brand-red-hover transition-colors">
