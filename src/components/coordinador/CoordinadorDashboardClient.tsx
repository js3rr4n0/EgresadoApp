...
export default function CoordinadorDashboardClient({
  ...
  const [modalTab, setModalTab] = useState<"pdf" | "info" | "historial">("pdf");
            ...
            <div className="p-4 bg-brand-red text-white flex flex-wrap items-center justify-between gap-3 shrink-0">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  ...
                  className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-lg shadow-sm transition-all inline-flex items-center gap-1"
                  title="Aceptar coordinar esta propuesta"
                >
                  ✓ Aceptar
                </button>
                <button
                  ...
                  className="px-3 py-1.5 bg-rose-700 hover:bg-rose-800 text-white text-xs font-bold rounded-lg shadow-sm transition-all inline-flex items-center gap-1"
                  title="Rechazar asignación y devolver a Pendiente de Revisión"
                >
                  ✕ Rechazar
                </button>
                <button
                  ...
                  className="px-3 py-1.5 bg-white text-brand-red hover:bg-rose-50 text-xs font-bold rounded-lg shadow-sm transition-all inline-flex items-center gap-1"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                  </svg>
