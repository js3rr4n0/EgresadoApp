...
const navItems = [
  ...
  { label: "Facultades y Carreras", href: "/admin/periodos", icon: ( // using periodos route as placeholder based on what exists
  ...
  { label: "Trabajos de Graduación", href: "/admin/empresas", icon: ( // placeholder route mapping
